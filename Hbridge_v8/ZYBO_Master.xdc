...
##Pmod Header JD
##IO_L5N_T0_34
set_property PACKAGE_PIN T15 [get_ports {jd[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[0]}]

##IO_L5P_T0_34
set_property PACKAGE_PIN T14 [get_ports {jd[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[1]}]

##IO_L6N_T0_VREF_34
set_property PACKAGE_PIN R14 [get_ports {jd[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[2]}]

##IO_L6P_T0_34
set_property PACKAGE_PIN P14 [get_ports {jd[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[3]}]

##IO_L11N_T1_SRCC_34
set_property PACKAGE_PIN U15 [get_ports {jd[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[4]}]

##IO_L11P_T1_SRCC_34
set_property PACKAGE_PIN U14 [get_ports {jd[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[5]}]

##IO_L21N_T3_DQS_34
set_property PACKAGE_PIN V18 [get_ports {jd[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {jd[6]}]

##IO_L21P_T3_DQS_34
set_property PACKAGE_PIN V17 [get_ports {jd[7]}]
